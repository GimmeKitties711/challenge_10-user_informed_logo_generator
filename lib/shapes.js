...
class Circle extends Shape {
    constructor(text, textColor, shapeColor) {
        super(text, textColor, shapeColor); // super() calls the constructor of the parent class, Shape
    }
    ...
    // if shapeColor is white, the shape cannot be seen against the white background of the svg file unless it has a border
