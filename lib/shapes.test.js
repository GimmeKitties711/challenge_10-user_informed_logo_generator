...
describe('Shapes', () => {
    describe('Circle', () => {
        it('should render a circle', () => {
            ...
            const shape = new Circle('abc', 'black', shapeColor); // text, textColor, shapeColor
            expect(shape.render()).toContain(`<circle cx="150" cy="100" r="80" fill="${shapeColor}" stroke="black" stroke-width="1"/>`);
            // the substring in toContain() is expected to be found in the render() method of the Circle class
            // source for how to use toContain(): https://jestjs.io/docs/expect#tocontainitem
        });
    });
});
